    ...
    <div className="max-w-7xl mx-auto p-6">
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-5">
          ...
          <TabsTrigger className='cursor-pointer' value="inventory">Inventory</TabsTrigger>
          <TabsTrigger className='cursor-pointer' value="alerts">Alerts</TabsTrigger>
          <TabsTrigger className='cursor-pointer' value="pickup">Ready for Pickup</TabsTrigger>
          <TabsTrigger className='cursor-pointer' value="pos">Point of Sale</TabsTrigger>
        </TabsList>
